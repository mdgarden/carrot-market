        ...
        <form className="mt-8 flex flex-col">
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                type="email"
                className="w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none"
                required
              />
            ) : null}
            {method === "phone" ? (
          ...
          <button className="mt-5 rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-orange-500">
